// Careful! I edited this! -- Isaac Menchaca
var jsPsychMaxdiff = (function (jspsych) {
  ...
  class MaxdiffPlugin {
      ...
      trial(display_element, trial) {
          ...
          // Start with column headings -- this is denoted by th
          ...
          html +=
              '<div><input type="submit" id="jspsych-maxdiff-next" class="jspsych-maxdiff jspsych-btn" ' +
                  enable_submit +
                  ' value="' +
                  trial.button_label +
                  '"></input>';
